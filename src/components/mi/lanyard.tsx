...
function Band({
  ...
  const texture = useTexture(lanyardImage || LANYARD_TEXTURE) as THREE.Texture;
  ...
  const cardMap = useMemo(() => {
    ...
    const baseImg = baseMap?.image as (HTMLImageElement | HTMLCanvasElement) | undefined;
    ...
    if (backImage && backTex.image) {
      ...
      drawFitted(frontTex.image as HTMLImageElement, BACK_UV_RECT);
    }
