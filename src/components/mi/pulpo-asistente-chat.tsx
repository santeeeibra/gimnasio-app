            ...
            {vista === "tecnica" && (
              <div className="space-y-3">
                ...
                {cargando ? (
                  ...
                  <div className="bg-canvas border border-rule rounded-[16px] p-5 text-center space-y-3">
                    <div className="flex justify-center">
                      <div className="relative inline-flex items-center justify-center rounded-[20px] bg-zinc-950 border border-emerald-500/30 p-2.5 shadow-xl overflow-hidden">
                        ...
                        <img
                          src="/mascota/pulpo-mareado.png"
                          alt="Pulpo Volt Mareado"
                          className="size-20 object-contain relative z-10"
                        />
                      </div>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-bold text-ink">¡Uy! Pulpo Volt se mareó un segundo 🐙</p>
                      <p className="text-xs text-ink-muted leading-relaxed">
                        {mensajeError}
                      </p>
                    </div>
                    <p className="text-[11px] text-ink-muted/80 bg-rule/30 p-2.5 rounded-[10px]">
                      Aviso enviado automáticamente al panel dev para revisar la ficha técnica.
                    </p>
                    <button
                      type="button"
                      onClick={volverAlMenu}
                      className="w-full py-2.5 rounded-[12px] bg-rule/50 hover:bg-rule text-xs font-semibold text-ink active:scale-95 transition-transform"
                    >
                      Volver a opciones
                    </button>
                  </div>
