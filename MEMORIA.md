...
- 2026-09-12: Fondo personalizado en pantalla de check-in (kiosko): migracion 0066 (bucket checkin-fondos), tema.checkinFondo (activo/imagenUrl/origen/oscurecido) en src/lib/tema.ts, card en /panel/ajustes (checkin-fondo-uploader.tsx) con galeria de presets (src/lib/checkin/fondos-preset.ts, vacia, agregar WebP en public/checkin-fondos/) + subida propia del dueno, renderizado en checkin/layout.tsx con overlay de oscurecido + watermark "Gestionado con SysGym". Falta aplicar migracion 0066 y sumar imagenes precargadas.
