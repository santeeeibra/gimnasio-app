...
- **Calculadora de Discos & Prensa de Piernas (2026-09-13)**: Integrado selector de Prensa 45° (carro 30kg) y auto-detección según el ejercicio; dibujado gráfico SVG/CSS dinámico para cada tipo de equipo (W/Z zig-zag, Smith/Multipower con guías, Prensa 45° con carro central y barra Olímpica/Liviana).
